    ...
    <div class="header-top">
        <div class="container">
            ...
            <div class="header-right">
                ...
                <a href="#" class="login-toggle link-to-tab d-md-show"><i class="d-icon-user"></i>Sign
                    in</a>
                            ...
                            <div class="form-box">
                                <div class="tab tab-nav-simple tab-nav-boxed form-tab">
                                    <ul class="nav nav-tabs nav-fill align-items-center border-no justify-content-center mb-5" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active border-no lh-1 ls-normal" href="{{ route('admin.dashboard.index') }}">Login</a>
                                        </li>
                                        ...
                                        <div class="tab-pane active" id="signin">
                                            <form method="POST" action="{{ route('login') }}">
                                                ...
                                                <div class="form-group mb-3">
                                                    <input type="text" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" id="email" name="email" placeholder="Username or Email Address *" required>
                                                    @error('email')
                                                ...
                                                {{-- <a href="{{ route('admin.dashboard.index') }}" class="btn btn-dark btn-block btn-rounded">Login</a> --}}
                                            </form>
        ...
        <div class="container">
            <div class="header-left">
                ...
                <a href="{{ route('public.index') }}" class="logo">
                    <img src="{{ asset('ui/frontend/assets/images') }}/logo.png" alt="logo" width="153" height="44" />
                </a>
                <!-- End Logo -->
            ...
            <div class="header-right">
                        ...
                        <div class="products scrollable">
                            <div class="product product-wishlist">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{ asset('ui/frontend/assets/images') }}/wishlist/product-1.jpg" width="100" height="100" alt="product" />
                                    </a>
                            ...
                            <div class="product product-wishlist">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{ asset('ui/frontend/assets/images') }}/wishlist/product-2.jpg" width="100" height="100" alt="product" />
                                    </a>
                                    <button class="btn btn-link btn-close">
                                        <i class="fas fa-times"></i><span class="sr-only">Close</span>
                                    </button>
                            ...
                            <div class="product product-wishlist">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{ asset('ui/frontend/assets/images') }}/wishlist/product-3.jpg" width="100" height="100" alt="product" />
                                    </a>
                                    <button class="btn btn-link btn-close">
                                        <i class="fas fa-times"></i><span class="sr-only">Close</span>
                                    </button>
                ...
                <div class="dropdown cart-dropdown type2 off-canvas mr-0 mr-lg-2">
                    <a href="" class="cart-toggle label-block link">
                        ...
                        {{-- <i class="d-icon-bag"><span id="totalItem" class="cart-count">2</span></i>  --}}
                        <i class="d-icon-bag"><span id="cartItemCount" class="cart-count">{{ count($cartItems) }}</span></i>
                    </a>
                    <div class="canvas-overlay"></div>
                    <!-- End Cart Toggle -->
                    <div class="dropdown-box">
                        ...
                        <div class="products scrollable">
                            <div class="product product-cart">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{ asset('ui/frontend/assets/images') }}/cart/product-1.jpg" alt="product" width="80" height="88" />
                                    </a>
                                    <button class="btn btn-link btn-close">
                                        <i class="fas fa-times"></i><span class="sr-only">Close</span>
                                    </button>
                            ...
                            <div class="product product-cart">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{ asset('ui/frontend/assets/images') }}/cart/product-2.jpg" alt="product" width="80" height="88" />
                                    </a>
                                    <button class="btn btn-link btn-close">
                                        <i class="fas fa-times"></i><span class="sr-only">Close</span>
                                    </button>
                        ...
                        <div class="cart-action">
                            <a href="{{ route('carts.index') }}" class="btn btn-dark btn-link">View Cart</a>
                            <a href="{{ route('orders.create') }}" class="btn btn-dark"><span>Go To Checkout</span></a>
                        </div>
                        <!-- End of Cart Action -->
                    </div>
                    <!-- End Dropdown Box -->
                            ...
                            <div class="megamenu">
                                <div class="row">
                                    ...
                                    <div class="col-6 col-sm-4 col-md-4 col-lg-3 menu-banner menu-banner1 banner banner-fixed">
                                        <figure>
                                            <img src="{{ asset('ui/frontend/assets/images') }}/menu/banner-1.jpg" alt="Menu banner" width="221" height="330" />
                                        </figure>
                                        <div class="banner-content y-50">
                                            ...
                                            <a href="{{ route('public.shop') }}" class="btn btn-link btn-underline">shop now<i class="d-icon-arrow-right"></i></a>
                                        </div>
                                    </div>
                                    <!-- End Megamenu -->
                                </div>
                            ...
                            <div class="megamenu">
                                <div class="row">
                                    ...
                                    <div class="col-6 col-sm-4 col-md-3 menu-banner menu-banner2 banner banner-fixed">
                                        <figure>
                                            <img src="{{ asset('ui/frontend/assets/images') }}/menu/banner-2.jpg" alt="Menu banner" width="221" height="330" />
                        </figure>
