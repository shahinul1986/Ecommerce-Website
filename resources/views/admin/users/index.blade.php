                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                ALL USERS
                                <x-utilities.link-create href="{{ route('admin.users.create') }}" class="pull-right m-r-5" btnType="success" text="Add New User" icon="add" />
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center" style="white-space:nowrap;">
                                            <x-utilities.link-show href="{{ route('admin.users.show', $user->id) }}" text="SHOW" />
                                           
                                            
                                            <x-utilities.link-edit href="{{ route('admin.users.edit', $user->id) }}" text="EDIT" />
