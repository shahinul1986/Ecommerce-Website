                            ...
                            <form class="form-horizontal" action="{{ route('admin.sizes.update',  $size->id) }}" method="POST">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line {{ $errors->has('title') ? 'focused error' : '' }}">
                                               ...
                                               <x-forms.input type="text" name="title" value="{{ old('title', $size->title) }}" class=" @error('title') is-invalid @enderror" />
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-offset-2 col-md-offset-2 col-sm-offset-4 col-xs-offset-5">
                                        <x-utilities.link-list href="{{ route('admin.sizes.index') }}" color="danger" text="back" />
