                        ...
                        <div class="body">
                            <form class="form-horizontal" action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        @foreach ($categories as $key=>$category)
                                            <div class="form-group">
                                                <x-forms.checkbox name="category[]" text="{{ $category }}" id="{{ $key }}" value="{{ $key }}" checked="" />
                                            </div>
                                        @endforeach
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        @foreach ($sizes as $key=>$size)
                                            <div class="form-group">
                                                <x-forms.checkbox name="size[]" text="{{ $size }}" id="{{ $key }}" value="{{ $key }}" checked="" />
                                            </div>
                                        @endforeach
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        @foreach ($colors as $key=>$color)
                                            <div class="form-group">
                                                <x-forms.checkbox name="color[]" text="{{ $color }}" id="{{ $key }}" value="{{ $key }}" checked="" />
                                            </div>
                                        @endforeach
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            ...
                                            <x-select-brand name="brand_id" text="brand" />
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line {{ $errors->has('price') ? 'focused error' : '' }}">
                                                ...
                                                <x-forms.input type="number" name="price" value="{{ old('price') }}" class=" @error('price') is-invalid @enderror" />
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line {{ $errors->has('discounted_price') ? 'focused error' : '' }}">

                                                <x-forms.input type="number" name="discounted_price" value="{{ old('discounted_price') }}" class=" @error('discounted_price') is-invalid @enderror" />
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line {{ $errors->has('quantity') ? 'focused error' : '' }}">
                                                ...
                                                <x-forms.input type="number" name="quantity" value="{{ old('quantity') }}" class=" @error('quantity') is-invalid @enderror" />
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line {{ $errors->has('summary') ? 'focused error' : '' }}">

                                                <x-forms.textarea class="@error('summary') is-invalid @enderror" name="summary" value="{{ old('summary') }}" />
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line {{ $errors->has('description') ? 'focused error' : '' }}">
                                                ...
                                                <x-forms.textarea class="@error('description') is-invalid @enderror" name="description" value="{{ old('description') }}" />
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7 col-lg-offset-2 col-md-offset-2">
                                        <div class="form-group">
                                            ...
                                            <x-forms.checkbox name="in_stock" text="in stock" checked="" />
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7 col-lg-offset-2 col-md-offset-2">
                                        <div class="form-group">
                                            ...
                                            <x-forms.checkbox name="is_featured" text="is featured" checked="" />
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-offset-2 col-md-offset-2 col-sm-offset-4 col-xs-offset-5">
                                        ...
                                        <x-utilities.link-list href="{{ route('admin.products.index') }}" color="danger" text="back" />
