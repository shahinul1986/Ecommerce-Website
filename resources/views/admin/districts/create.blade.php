            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form class="form-horizontal" action="{{ route('admin.districts.store') }}" method="POST">
                                @csrf
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line {{ $errors->has('name') ? 'focused error' : '' }}">
                                                ...
                                                <x-forms.input type="text" name="name" value="{{ old('name') }}" class=" @error('name') is-invalid @enderror" />
