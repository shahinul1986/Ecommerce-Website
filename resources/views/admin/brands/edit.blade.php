                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line {{ $errors->has('title') ? 'focused error' : '' }}">
                                               ...
                                               <x-forms.input type="text" name="title" value="{{ old('title', $brand->title) }}" class=" @error('title') is-invalid @enderror" />
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7 col-lg-offset-2 col-md-offset-2">
                                        <div class="form-group">
                                            ...
                                            <x-forms.checkbox name="is_active" text="is active" checked="{{ $brand->is_active ? 'checked' : '' }}"/>
