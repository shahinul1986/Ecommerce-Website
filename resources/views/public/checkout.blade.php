        ...
        <main class="main checkout">
            <div class="page-content pt-7 pb-10 mb-10">
                <div class="step-by pr-4 pl-4">
                    ...
                    <h3 class="title title-simple title-step active"><a href="{{ route('orders.create') }}">2. Checkout</a></h3>
                    ...
                    <form action="{{ route('orders.store') }}" method="POST" class="form">
                        ...
                        <div class="row">
                            <div class="col-lg-7 mb-6 mb-lg-0 pr-lg-4">
                                ...
                                <input type="text" class="form-control" name="street_address" placeholder="House number and street name" />
                                ...
                                <textarea class="form-control pb-2 pt-2 mb-0" cols="30" rows="5" name="additional_info" placeholder="Notes about your order, e.g. special notes for delivery"></textarea>
                            </div>
                                ...
                                <div class="sticky-sidebar mt-1" data-sticky-options="{'bottom': 50}">
                                    <div class="summary pt-5">
                                        ...
                                        <table class="order-table">
                                            ...
                                            <tbody>
                                                @foreach ($orderItemsAll as $orderItem)
                                                <tr>
                                                    <td class="product-name">
                                                        <input type="hidden" name="item_id[]" value="{{$orderItem->product->id}}" />
                                                        {{ $orderItem->product->title }}
                                                    </td>
                                                    <td class="product-total text-body">${{ number_format($orderItem->unit_price, 2) }}<span class="product-quantity">×&nbsp;{{ $orderItem->qty }}</span>
                                                        <input type="hidden" name="qty[]" class="qty-input" type="number" value="{{ $orderItem->qty }}">
                                                    </td>
                                                    <td class="product-total text-body">${{ number_format($orderItem->total_price ?? '0', 2) }}</td>
                                                </tr>
                                                @endforeach
                                                {{-- <tr>
                                            ...
                                            <tr>
                                                ...
                                                <tr class="summary-subtotal">
                                                    ...
                                                    <td class="summary-subtotal-price pb-0 pt-0">${{ number_format($cart->total_price ?? '0', 2) }}
                                                    </td>
                                                </tr>
                                                ...
                                                <tr class="summary-total">
                                                    ...
                                                    <td class=" pt-0 pb-0">
                                                        <p class="summary-total-price ls-s text-primary">${{ number_format($cart->total_price ?? '0', 2) }}</p>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                        <div class="payment accordion radio-type">
                                            ...
                                            <div class="card">
                                                <div class="card-header">
                                                    <a href="#collapse3" class="expand text-body text-normal ls-m">SSLCOMMERZ</a>
                                                </div>
                                                <div id="collapse3" class="collapsed">
                                                    <div class="card-body ls-m">
                                                        Pay with payment gateway SSLCOMMERZ.
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-checkbox mt-4 mb-5">
                                            <input type="checkbox" class="custom-checkbox" id="terms-condition" name="terms_condition" value="1" />
                                        ...
                                        {{-- <a href="{{ route('public.order') }}" class="btn btn-dark btn-rounded btn-order">Place Order</a> --}}
                                    </div>
                                </div>
                            </aside>
                        </div>
